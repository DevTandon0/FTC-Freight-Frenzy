...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 12.5424; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 5; // in; offset of the lateral wheel

    public static double X_MULTIPLIER = 1.3115;
    public static double Y_MULTIPLIER = 1.0151;
