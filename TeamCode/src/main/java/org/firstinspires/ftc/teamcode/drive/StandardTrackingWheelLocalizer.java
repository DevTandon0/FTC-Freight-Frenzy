...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 11.605; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 3.5; // in; offset of the lateral wheel

    public static double X_MULTIPLIER = 1.01882457058;
    public static double Y_MULTIPLIER = 1.0414;
